...
public class ScreenTransition : MonoBehaviour
{
    ...
    public static void JustLoadScene(string SceneName, string LoadingSceneName)
    {
        ScreenTransitionGoto(SceneName, LoadingSceneName, Color.black, 0, 0.5f, 2.0f, 0.5f, 0);
    }

    public static void ScreenTransitionGoto(string SceneName, string LoadingSceneName, Color CurtainColor,
        float WaitTime1, float FadeOutTime, float LoadingTime, float FadeInTime, float WaitTime2)
    {
        if (Instance == null)
        {
    ...
    private IEnumerator StartTransition()
    {
        ...
        if (InventoryManager.instance != null) InventoryManager.instance.ShowInventory(false);
    ...
    private IEnumerator FinishTransition()
    {
        ...
        if (InventoryManager.instance != null) InventoryManager.instance.ShowInventory(true);
